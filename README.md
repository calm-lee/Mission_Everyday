...
* 운동, 공부, 외국어 등  다양한 카테고리의 미션 가입
* 인증 포스트 올리기  (사진  첨부  필수)
* 좋아요, 댓글달기 가능
* 마이페이지에서 내 인증현황 확인 가능

<b>5. 사용 기술 스택</b>
* 백엔드: Java, Spring Boot 4.11, Apache Tomcat 9.0 
* 프론트엔드: JavaScript, Ajax, HTML, CSS, jQuery, BootStrap
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FD7XGg%2FbtrlPoZL4op%2FEnrZiLm3PRmuTViazQsI7k%2Fimg.png" alt="user_id_duplicated" width="360px">  
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FnzNRu%2FbtrlNcyDE99%2FeNyyd89ztSZ75YWlkQyawk%2Fimg.png" alt="category&mission_function" width="480px">  
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FcCpuDX%2FbtrlD2LdY5T%2FeEWSaerMUJoKoqpwCCDlGK%2Fimg.png" alt="post_timeline">  
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FMWobC%2FbtrlEJkIKTK%2F2sKDZeYYkqRLRzKW6vhMp1%2Fimg.png" alt="myMission_detail" width="420px">  
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbfIcJb%2FbtrlFJkcbZ5%2F8Eup7BhEd9VdKey6kPeakK%2Fimg.png" alt="myPost_detail" width="420px">  
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FnjAEY%2FbtrlNcrSC3K%2FBQewu933aE9oSulhi1qkfK%2Fimg.png" alt="myPostStatus_detail">  

<br/><br/>
## 프로젝트 설계 과정
### 1. 기획서
> 카카오 오븐을 통해 [기획서](https://ovenapp.io/project/u1vPXyC6FPiBUZFJYClPuW5lQGtSjUf9#1HJPw)를 설계했습니다.  

### 2. DB 설계
> 사용 용도에 맞게 다음과 같이 DB를 설계했습니다.

 1) user : 로그인, 회원가입, 마이페이지에  사용
 2) category : 카테고리, 미션 페이지에 사용
 3) mission : 상세 미션 페이지에 사용
 4) mission_user : 미션 별 유저의 수를 조회하는 데 사용 (관계 테이블)
 5) post : 포스트 생성/수정/삭제에 사용
 6) comment : 댓글 생성/삭제에 사용
 7) like : 좋아요 생성/해제에 사용  
...
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FcxA4wo%2FbtrlpVKUCiy%2FVupLCCxdXvdOKZukq0GHDK%2Fimg.png" alt="setting" width="480">  


>MVC pattern을 통해 Model<->View(JSP)<->Controller가 상호작용하도록 처리했습니다.
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FMjNpH%2FbtrloyCFNcm%2Fh5KqEvlMxqErWJN7uebOZk%2Fimg.png" alt="mvc" width="480">

* JSP: View 화면 구축
* JavaScript: 동적 화면 구축
* AJAX: Data, Request 전달
* Java: Controller, Service, Repository로 Request/Response 처리
* MyBatis: Mapper로 MySQL에 쿼리 실행

### 5. 배포
>AWS 배포 구조
<img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FdahPdn%2FbtrlOWoKpkj%2FuUdEK3QbJoCxfC5k1tDN9k%2Fimg.png" alt="release" width="480">  
